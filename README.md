...
在这个过程中踩了很多坑，请教了很多人，很多个夜晚睡不着觉，想尽一切办法积累数据，有很多次会想放弃，持续专注的做了一年，最终呈现一个效果还不错的结果。
...
|调整项	| deepspeech 2模型	| deepspeech-enhance模型	| 准确率 | 	性能 | 	资源占用|
|----|----|----|----|----|-----|
...
- deepspeech-enhance的解码模块使用现在GitHub 上比较热门的mozilla基金会实现的beam search解码模型，n-gram的作用就是进一步纠错，在权威性、准确率和性能方面都比之前deepspeech好很多，调整后准确率平均提升6个百分点以上。
